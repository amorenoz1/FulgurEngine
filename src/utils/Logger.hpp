...
namespace Utils
{
    ...
    enum class LoggingPriority : uint8_t
    {
        TRACE,
        INFO,
        WARNING,
    ...
    enum class LoggingTimeStyle : uint8_t
    {
        EXECUTION,
        CURRENT,
        NOTIME
    ...
    enum class LoggingOutput : uint8_t
    {
        CONSOLE,
        FILE,
        BOTH
    ...
    enum class LoggingColor : uint8_t
    {
        ENABLED,
        DISABLED
    };

    enum class LoggingFormat : uint8_t
    {
        DEFAULT,
        VERBOSE,
        EXTENDED
